...
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 11 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:11//ALL --dropout 0.2
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 22 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:22//ALL --dropout 0.2
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 33 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:33//ALL --dropout 0.2
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 44 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:44//ALL --dropout 0.2
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 55 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:55//ALL --dropout 0.2
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-dp/main_ours.py --seed 66 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --c 0.20 0.30 0.50 --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//seed:66//ALL --dropout 0.2


# KLUE-NER
ex_ipa_path=words/ipas_klue_ner.txt
ex_emb_path=./embeddings/klue-ner/love_kor_jm.emb
ex_emb_path_ipa=./embeddings/klue-ner/love_kor_ipa.emb
output_path=extrinsic/klue-ner/output/f2
task=klue_ner
...
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 11 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:11
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 22 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:22
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 33 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:33
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 44 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:44
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 55 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:55
CUDA_VISIBLE_DEVICES=$n python extrinsic/klue-ner/main_ours.py --seed 66 --output_path $output_path --pretrain_embed_path $ex_emb_path --pretrain_embed_path_ipa $ex_emb_path_ipa --lamda $lamda --postfix input_type:$input_type//model_path:$ex_model_path//lamda:$lamda//num_layers:$num_layers//seed:66
