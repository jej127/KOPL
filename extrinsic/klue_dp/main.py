...
parser.add_argument('--output_path', default='extrinsic/klue-dp/output')
parser.add_argument('--batch_size', type=int, default=32)
# parser.add_argument('--epochs', type=int, default=15)
# parser.add_argument('--lr', type=float, default=3e-4)
parser.add_argument('--epochs', type=int, default=15)
parser.add_argument('--lr', type=float, default=2e-4)
parser.add_argument('--vocab_path', default='extrinsic/klue-dp/data/words.txt')
parser.add_argument('--train_path', default='extrinsic/klue-dp/data/klue-dp-v1.1_split_train.tsv')
parser.add_argument('--dev_path', default='extrinsic/klue-dp/data/klue-dp-v1.1_split_val.tsv')
parser.add_argument('--test_path', default='extrinsic/klue-dp/data/klue-dp-v1.1_dev.tsv')
...
def run_klue_dp(args):
    ...
    test_data_30_nat = load_sent_by_id('./extrinsic/klue-dp/data/klue-dp-v1.1_dev_natural_30.tsv', word_dict)
